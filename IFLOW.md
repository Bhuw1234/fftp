...
| IPFS (kubo v0.35.0, boxo v0.32.0) | 分布式存储 |
...
│   ├── nats/                  # NATS 集成 (30 文件)
│   ├── node/                  # 节点管理
│   ├── orchestrator/          # 编排器逻辑 (97 文件)
│   ├── publicapi/             # 公共 API (56 文件)
│   ├── publisher/             # 发布器
│   ├── pubsub/                # 发布订阅
│   ├── repo/                  # 仓库管理
│   ├── s3/                    # S3 集成
...
│   └── version/               # 版本管理
│
├── webui/                     # Web 界面 (Next.js 15, 133 文件)
│   ├── app/                   # Next.js App Router
│   │   ├── jobs/              # 作业管理页面
│   │   ├── nodes/             # 节点管理页面
│   │   └── providers/         # React Context
│   ├── components/            # React 组件 (50 文件)
│   │   ├── jobs/              # 作业相关组件
│   │   ├── nodes/             # 节点相关组件
│   │   ├── layout/            # 布局组件
│   │   └── ui/                # 通用 UI 组件
...
│   └── webui.go               # Go 嵌入文件
│
├── python/                    # Python SDK (25 文件)
│   ├── bacalhau_sdk/          # SDK 核心代码
│   ├── examples/              # 示例代码
│   └── tests/                 # 测试套件
│
├── clients/                   # API 客户端 (245 文件)
│   └── python/                # Python API 客户端 (238 文件)
│
├── integration/               # 第三方集成 (55 文件)
│   ├── airflow/               # Apache Airflow 集成
│   └── flyte/                 # Flyte 集成
│
├── deparrow/                  # DEparrow 平台 (39 文件)
│   ├── alpine-layer/          # Alpine Linux 基础层
│   ├── bacalhau-layer/        # Bacalhau 层
│   ├── bootable/              # 可启动镜像
│   ├── gui-layer/             # GUI 用户界面层 (20 文件)
│   ├── metaos-layer/          # Meta-OS 控制平面层
│   ├── test-integration/      # 集成测试
│   ├── DEPLOYMENT.md          # 部署指南
│   └── IMPLEMENTATION_COMPLETE.md
│
├── clawdbot/                  # Clawdbot AI 助手 (4244 文件, 独立项目)
│   ├── src/                   # 源代码 (2497 文件)
│   ├── apps/                  # 应用程序 (516 文件)
│   ├── extensions/            # 扩展 (547 文件)
│   ├── docs/                  # 文档 (307 文件)
│   ├── skills/                # 技能 (74 文件)
│   ├── ui/                    # UI 组件 (124 文件)
│   └── Swabble/               # Swabble 模块
...
├── docs/                      # 文档
│
└── .github/workflows/         # CI/CD 工作流 (10 文件)
    ├── main.yml               # 主分支构建
    ├── pr-checks.yml          # PR 检查
    ├── release.yml            # 发布流程
    ├── _build.yml             # 二进制构建
